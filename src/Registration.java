...
public class Registration extends JFrame {
	...
	public Registration() {
		...
		cmbSecQ.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		Image Img2 =  new ImageIcon (this.getClass().getResource("/Registration x350.png")).getImage();
